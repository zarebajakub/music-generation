...
genre_w_instr = f"{genre}-tuba"
saved_model = "best-100"
song_length = 200
instr = instrument.Tuba()
...
def create_midi(prediction_output):
    ...
    for pattern in prediction_output:
        ...
        # pattern is a note
            ...
            if (last_pattern == pattern):
                ...
                output_notes[-1].duration = duration.Duration(output_notes[-1].duration.quarterLength + 1)
    ...
    # print([[note, note.duration] for note in output_notes])

    midi_stream = stream.Score()
    midi_stream.insert(0, output_notes)

    midi_stream.write('midi', fp=f'results/{genre_w_instr}-{saved_model}-w-joining.mid')
